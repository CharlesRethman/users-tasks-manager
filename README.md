...
The project was initiated with the Swagger-Node codegen, an npm package that was installed globally (`swagger project create users-tasks-manager`). This README was written up.
